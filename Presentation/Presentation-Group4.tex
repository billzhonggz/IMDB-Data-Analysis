...
\makeatother
    ...
    \section{Analysis on IMDb Movie Data}\label{analysis-on-imdb-movie-data}

\subsection{Group Information}\label{group-information}
...
\item
  1430003030 Frank
\item
  1430003045 Bill \#\# Collecting Data The data comes from
  Kaggle, which collects data of 1000 movies. \#\#\# Kaggle Kaggle is a
  ...
  users.{[}Wikipedia{]} \includegraphics{kaggle-data.png} \#\#\# IMDb
  ...
  \includegraphics{imdb-mainpage.png} \#\#\# Movies on IMDb
  \includegraphics{imdb-movie.png}
\end{itemize}

    \subsection{Analysis}\label{analysis}

Five analyses were brought out by members in the group. \#\#\# Analysis
on Directors This analysis was posted by \textbf{Junru (Bill) Zhong},
and the following aims were setted. * Find out which director earned
most. * Find out the genres of the works of the five-most earned
directors. * Estimate how much each of them will get in their next film.

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}3}]:} \PY{c+c1}{\PYZsh{} Import package}
